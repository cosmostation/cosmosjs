...
> :warning: ** This repo is class version. It's @cosmostation/cosmosjs@0.9.x**: Be very careful! If you need to use protobuf tx type, you can download @cosmostation/cosmosjs@0.10.0+. You can download it from `master` branch.
